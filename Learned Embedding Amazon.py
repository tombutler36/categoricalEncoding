...
x1 = pd.read_csv('x_train_amz.csv', header=None)
x2 = pd.read_csv('x_test_amz.csv', header=None)
y1 = pd.read_csv('y_train_amz.csv', header=None)
y2 = pd.read_csv('y_test_amz.csv', header=None)
x1 = x1.astype(str)
x2 = x2.astype(str)
